...
asmlinkage long sys_kern_queue_init(void);

asmlinkage long sys_kern_queue_free(void);

asmlinkage long sys_kern_dequeue(void __user *dest);

asmlinkage long sys_kern_enqueue(void __user *node);
