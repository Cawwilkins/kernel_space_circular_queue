...
#define __NR_kern_queue_init (__X32_SYSCALL_BIT + 600)
#define __NR_kern_queue_free (__X32_SYSCALL_BIT + 601)
#define __NR_kern_dequeue (__X32_SYSCALL_BIT + 602)
#define __NR_kern_enqueue (__X32_SYSCALL_BIT + 603)
